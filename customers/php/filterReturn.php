...
if($_POST['fromDate'] != null && $_POST['fromDate'] != ''){
  ...
  $searchQuery = " and goods_return.return_date >= '".$fromDateTime."'";
}

if($_POST['toDate'] != null && $_POST['toDate'] != ''){
  $dateTime = DateTime::createFromFormat('d/m/Y', $_POST['toDate']);
  $toDateTime = $dateTime->format('Y-m-d 23:59:59');
	$searchQuery .= " and goods_return.return_date <= '".$toDateTime."'";
}

if($_POST['hypermarket'] != null && $_POST['hypermarket'] != '' && $_POST['hypermarket'] != '-'){
	$searchQuery .= " AND goods_return.return_details LIKE '%" . addslashes('\"hypermarket\":\"' . $_POST['hypermarket'] . '\"') . "%'";
}

if($_POST['outlet'] != null && $_POST['outlet'] != '' && $_POST['outlet'] != '-'){
	$searchQuery .= " AND goods_return.return_details LIKE '%" . addslashes('\"location\":\"' . $_POST['outlet'] . '\"') . "%'";
}

if($_POST['driver'] != null && $_POST['driver'] != '' && $_POST['driver'] != '-'){
	$searchQuery .= " and goods_return.driver = '".$_POST['driver']."'";
}

if($_POST['customer'] != null && $_POST['customer'] != '' && $_POST['customer'] != '-'){
	$searchQuery .= " and goods_return.customer = '".$_POST['customer']."'";
}

if($_POST['status'] != null && $_POST['status'] != '' && $_POST['status'] != '-'){
  $searchQuery = " and goods_return.status = '".$_POST['status']."'";
}

if($_POST['grn'] != null && $_POST['grn'] != '' && $_POST['grn'] != '-'){
	$searchQuery .= " AND goods_return.GR_No LIKE '%" . $_POST['grn'] . "%'";
}
...
goods_return.total_carton, goods_return.return_type FROM goods_return, customers WHERE goods_return.customer = customers.id 
AND goods_return.customer = '".$user."' AND goods_return.deleted = '0'".$searchQuery." 
