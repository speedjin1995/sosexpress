...
hypermarket.name as hypermarket, states.states, zones.zones, outlet.name as outlet, do_type, do_number, po_number, note, actual_carton, 
need_grn, loading_time from do_request, hypermarket, outlet, states, customers, zones WHERE do_request.customer = customers.id AND 
