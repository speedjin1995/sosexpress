        ...
        <form role="form" id="lotForm">
            ...
            <div class="modal-body">
                <div class="card-body">
    				...
    				<div class="form-group">
    					<label for="lotsNumber">Roles *</label>
    					<input type="text" class="form-control" name="roles" id="roles" placeholder="Enter Roles" required>
    				</div><br><br>
                    <?php displayModulesInNestedTable($moduleTree); ?>
    			</div>
            </div>
